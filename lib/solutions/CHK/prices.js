...
class PricingStrategy {
    ...
    */
    sortByDiscount(a, b) {
        ...
        return this.calculateDiscount(a) - this.calculateDiscount(b)
    }
    ...
    buildPricingStrategy() {
        ...
        // priceList.sort(this.sortByDiscount)

        return priceList
    }
}

const priceBuilder = new PricingStrategy(BASE_PRICES)
...
const PRICE_LIST = priceBuilder.buildPricingStrategy()
